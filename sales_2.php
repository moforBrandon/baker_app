...
<body>
    ...
    <label for="type"> New Name & Adress:</label>
     <input type="text" class="option" placeholder="new client"><br><br>
    ...
    <select id="bread_type" class="option">
        <option value="small">Check</option>
        <option value="regular">Zelle</option>
    ...
    <button class="btn1"> <a href="sales.php" class="btn">back</button>
